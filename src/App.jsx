...
const ACTIONS = [
  {
    ...
    label: 'ちょい交流',
    base: 5,
    keywords: ['ジュース', '自販機', '飲み物', 'ドリンク', '一緒に'],
    templates: [
      '【{dept}】{name}さんと一緒に自販機へ行き、飲み物を選んでみよう',
      '【{dept}】{name}さんと飲み物を片手に、30秒だけ雑談してみよう',
    ],
  },
  {
    key: 'chat',
    label: '雑談',
    base: 6,
    keywords: ['雑談', '話した', '会話', '近況', '一緒に'],
    templates: [
      '【{dept}】{name}さんとすれ違いざまに、30秒だけ近況を話してみよう',
      '【{dept}】{name}さんと最近あった小さな出来事を1つ共有してみよう',
    ],
  },
  {
    key: 'coffee',
    label: 'ひと休み',
    base: 8,
    keywords: ['コーヒー', 'お茶', '休憩', 'カフェ', '一緒に'],
    templates: [
      '【{dept}】{name}さんと10分だけコーヒーブレイクをしてみよう',
      '【{dept}】{name}さんと一緒に休憩を取り、今週忙しかったことを共有しよう',
    ],
  },
  {
    key: 'lunch',
    label: 'ランチ',
    base: 12,
    keywords: ['ランチ', '昼', 'ご飯', '一緒に'],
    templates: [
      '【{dept}】{name}さんと一緒にランチをして、仕事以外の話を1つしてみよう',
      '【{dept}】{name}さんとランチをしながら、最近ハマっていることを交換しよう',
    ],
  },
  {
    key: 'collab',
    label: '協働',
    base: 15,
    keywords: ['一緒に', '共有', '相談', '整理', '話し合い'],
    templates: [
      '【{dept}】{name}さんと一緒に、今ちょっと困っていることを整理してみよう',
      '【{dept}】{name}さんと最近の仕事の流れを共有してみよう',
    ],
  },
];
